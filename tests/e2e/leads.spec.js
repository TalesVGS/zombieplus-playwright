...
test('não deve cadastrar com e-mail incorreto', async ({ page }) => {
  ...
  await page.landing.visit()
  await page.landing.openLeadModal()
  await page.landing.submitLeadForm('Tales Víctor', 'talesvictorsagmail.com')
...
test('não deve cadastrar quando o nome não for preenchido', async ({ page }) => {
  ...
  await page.landing.visit()
  await page.landing.openLeadModal()
  await page.landing.submitLeadForm('', 'talesvictorsa@gmail.com')

  await page.landing.alertHaveText('Campo obrigatório')

});

test('não deve cadastrar quando o email não for preenchido', async ({ page }) => {

  await page.landing.visit()
  await page.landing.openLeadModal()
  await page.landing.submitLeadForm('Tales Víctor', '')
